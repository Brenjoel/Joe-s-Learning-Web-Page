...
session_start(); 
// echo $_SESSION['courses']."1\n";
// echo "\n".$_SESSION['email'];
// echo "\n".$_SESSION['firstname'];
// echo $_SESSION['courses']."321\n";
// echo $_SESSION['firstname']."321\n";

$_SESSION['courses']=$_SESSION['courses']."</br> , Introduction to Artificial Intelligence ";
$a=$_SESSION['courses'];
// echo "123 \n".$a;
$b=$_SESSION['email'];
$c=$_SESSION['pass'];
